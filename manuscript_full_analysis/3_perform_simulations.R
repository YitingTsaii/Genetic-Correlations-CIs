...
# turn off BLAS parallelism to run rmvn
library(RhpcBLASctl)
...
block_size <- 1000 #to split 10K replications into sequential 10 sequential blocks (10000/1000 = 10)

#for data sims that would be 1 block because n.sim is 1000
num_blocks <- n.sim/block_size 
